...
class TestServerHTTPSettings:
    ...
    def test_cors_settings_default_to_maltego_app_origin(self):
        http_settings = ServerHTTPSettings()

        assert http_settings.cors_allowed_origins == ["https://app.maltego.com"]
...
class TestServerHTTPSettingsEnvPriority:
    ...
    def test_env_overrides_cors_allowed_origins(self, monkeypatch):
        monkeypatch.setenv(
            "MALTEGO_SERVER_CORS_ALLOWED_ORIGINS",
